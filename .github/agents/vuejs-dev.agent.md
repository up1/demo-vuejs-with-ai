...
- Component testing with [Vue Test Utils](https://vue-test-utils.vuejs.org/) and [Vitest](https://vitest.dev/)
...
5. Write unit tests for the `ItemList` component using Vue Test Utils and Vitest to verify that it renders correctly based on the provided props.
